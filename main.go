...
import (
	...
	"github.com/croz-ltd/external-postgres-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "573cec80.croz.net",
	})
	if err != nil {
	...
	if err = (&controllers.PostgresRoleReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("PostgresRole"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
